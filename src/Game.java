...
class Game {
	...
	public Game() {
		...
		Store Systemet = new Store("Systembolaget",
				"Välkommen till Systemet, Här handlar vi på oss viktiga förnödenheter inför kvällen.");
		Store Donken = new Store("Donken",
				"Välkommen till Donken, Här fyllekäkar vi efter episka kvällar på Kårallen.");
	...
	public void run() {
		...
		System.out.println(name + ", du befinner dig just nu vid " + player.getPosition().getName() + ", "
